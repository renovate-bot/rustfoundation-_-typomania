...
- *(deps)* lock file maintenance ([#24](https://github.com/renovate-bot/rustfoundation-_-typomania/pull/24))
- *(deps)* Pin `dtolnay/rust-toolchain` action with explicit `toolchain: stable`
- *(deps)* pin dependencies
- *(deps)* update rust crate criterion to 0.8 ([#21](https://github.com/renovate-bot/rustfoundation-_-typomania/pull/21))
